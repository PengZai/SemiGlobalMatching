...
PROJECT_NAME="semi_global_matching"
...
docker build -t $IMAGE_NAME -f "${HOME}/vscode_projects/SemiGlobalMatching/Docker/Dockerfile.txt" .
...
docker run \
    ...
    -v ${HOME}/vscode_projects/SemiGlobalMatching/:/root/SemiGlobalMatching \
